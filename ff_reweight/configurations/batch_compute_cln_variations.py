...
if __name__ == '__main__':
    ...
    executable_path = '../compute_cln_variations'
    executable_cfg_template = 'compute_cln_variations_python_template.cfg'
    populate_sql_script_template = 'populate_cln_variations_sql_template.sql'
