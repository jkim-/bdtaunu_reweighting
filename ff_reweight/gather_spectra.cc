...
int main() {
  ...
  std::ofstream BD0mu_fout("BD0mu.csv");
  std::ofstream BD1mu_fout("BD1mu.csv");
  std::ofstream BD2mu_fout("BD2mu.csv");
  std::ofstream BD1primemu_fout("BD1primemu.csv");

  std::ofstream BD0tau_fout("BD0tau.csv");
  std::ofstream BD1tau_fout("BD1tau.csv");
  std::ofstream BD2tau_fout("BD2tau.csv");
  std::ofstream BD1primetau_fout("BD1primetau.csv");
